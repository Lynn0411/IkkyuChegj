...
- (void)setupLabels {
	label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width-15, self.bounds.size.height-15)];
	...
	detailsLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width-15, self.bounds.size.height-15)];
...
- (void)drawRect:(CGRect)rect {
	...
	CGRect boxRect = CGRectMake(roundf((allRect.size.width - size.width) / 2) + self.xOffset+5,
								roundf((allRect.size.height - size.height) / 2) + self.yOffset+5, size.width-15, size.height-15);
	float radius = 10.0f;

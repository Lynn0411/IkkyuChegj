//
//  IkkyuChegjTabBarViewController.m
//  IkkyuChegj
//
...
//title选中颜色
#define TitleColor_Sel  RGBA(233, 84, 18, 1)
//title字体大小
...
//==============================================================
#pragma mark-@interface IkkyuChegjTabBarButton
@interface IkkyuChegjTabBarButton()

@end

@implementation IkkyuChegjTabBarButton
...
@end
//========================================================
#pragma mark-@interface IkkyuChegjTabBarViewController
@interface IkkyuChegjTabBarViewController ()
...
@property (nonatomic, strong) UINavigationController *IkkyuChegiNavCon;
@end
@implementation IkkyuChegjTabBarViewController
- (instancetype)init{
    self = [super init];
    if (self) {
...
- (instancetype)initWithControllerArray:(NSArray *)controllerArray titleArray:(NSArray *)titleArray imageArray:(NSArray *)imageArray selImageArray:(NSArray *)selImageArray height:(CGFloat )height{
    self = [super init];
    if (self) {
        self.IkkyuChegiNavCon = [IkkyuChegjNavigationController alloc];
...
-(void)createTabBarView{
    ...
    for(int i=0;i<num;i++){
        IkkyuChegjTabBarButton *button = [[IkkyuChegjTabBarButton alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/num*i, 0, [UIScreen mainScreen].bounds.size.width/num,self.tabBarHeight)];
        button.tag = 1000+i;
